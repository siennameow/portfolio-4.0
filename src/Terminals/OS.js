...
const initializeLocalStorage = () =>{
    let tree = localStorage.getItem('sienna-files');
    if(tree !== null)
        return
...
const saveData = (tree) => {
    ...
    localStorage.setItem('sienna-files',stringFileStructure)
}
...
export default class OS extends React.Component{
    ...
    terminalString = this.user + 'sienna@meow:~$ '


    constructor(props){
        super(props)
        initializeLocalStorage();
        this.tree = JSON.parse(localStorage.getItem('sienna-files'))
